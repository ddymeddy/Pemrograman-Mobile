...
// Mengimpor gambar banner dari folder aset.
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.topButtons}>
          <View style={styles.inlineButton}>
            <Button title="Login" onPress={() => router.push('/login')} color="#007bff" />
          </View>
          <View style={styles.inlineButton}>
            <Button title="Register" onPress={() => router.push('/register')} color="#28a745" />
          </View>
        </View>
      </View>
